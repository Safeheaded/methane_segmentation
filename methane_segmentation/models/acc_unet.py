...
class AccUnet(BaseModel):
    """
    ACC-UNet model
    """

    def __init__(self, n_classes = 1, n_filts=8, input_channels=18, learning_rate=1e-3, T_MAX=100):
        """
        Initialization
        ...
        self.cnv11 = HANCBlock(input_channels, n_filts, k=3, inv_fctr=3)
        ...
        self.loss_function = WeightedDiceBCE(dice_weight=0.5,BCE_weight=0.5, n_labels=1)
